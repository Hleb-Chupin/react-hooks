...
export const Profile = ({ match }) => {
    ...
    const {
        name, company, avatar_url, location, bio, folowwing,
        blog, login, html_url, followers, public_repos, public_gists
    } = user
                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col">
                            ...
                            <div className="badge badge-success">Folowing: {folowwing}</div>
